...
void init_texture_object(s32, u8*, const char**, u8, u16);
...
void func_80074510(const char**, const char*, size_t, size_t);
void func_800745C8(s32, const char**);
void func_8007466C(s32, const char**);
void func_80074704(s32, const char**);
size_t func_80074790(s32, const char**);
void func_800747F0(s32, const char**);
void func_80074894(s32, const char**);
void func_800748C4(s32, const char**);
void func_800748F4(s32, const char**);
